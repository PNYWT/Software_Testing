...
class TestBankAccountHw(unittest.TestCase):
    ...
    def test_withdraw_balance_greaterthanorequalto_amount_EP_A(self):
        self.account.withdraw(200)
        self.assertEqual(800, self.account.balance)

    def test_withdraw_balance_greaterthanorequalto_amount_EP_B(self):
        self.account.withdraw(-200)
        self.assertEqual(800, self.account.balance)
    ...
    def test_withdraw_balance_greaterthanorequalto_amount_BVA_A(self):
        self.account.withdraw(999)
        self.assertEqual(1, self.account.balance)

    def test_withdraw_balance_greaterthanorequalto_amount_BVA_B(self):
        self.account.withdraw(-999)
        self.assertEqual(1, self.account.balance)
